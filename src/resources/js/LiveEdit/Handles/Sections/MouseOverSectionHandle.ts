...
export class MouseOverSectionHandle extends ElementHandle {
    ...
    public handleMainOutsideElement;
    ...
    public createElementHandle() {
        ...
        this.iframeManager.document.body.appendChild(createElementHandle);
        ...
        // OUTSIDE IFRAME HANDLE
        const createElementHandleOutside = document.createElement("div");
        createElementHandleOutside.id = 'js-live-edit-section-handle-outside';
        createElementHandleOutside.innerHTML = '' +
        ...
        document.body.appendChild(createElementHandleOutside);

        this.handleMainOutsideElement = document.getElementById('js-live-edit-section-handle-outside');

        this.handleActionMoveElementDuplicate = document.getElementById('js-live-edit-section-handle-action-duplicate');
        ...
        this.handleActionMoveElementUp = document.getElementById('js-live-edit-section-handle-action-move-up');
        ...
        this.handleActionMoveElementDown = document.getElementById('js-live-edit-section-handle-action-move-down');
        ...
        this.handleActionRemove = document.getElementById('js-live-edit-section-handle-action-remove');
    ...
    public addListener()
    {
        ...
        app.iframeManager.document.addEventListener('mouseover', e => {
            ...
            if (mouseOverElement) {
                ...
                app.handleMainOutsideElement.style.width = (getElementParentSectionElement.offsetWidth) + 'px';
                app.handleMainOutsideElement.style.height = (getElementParentSectionElement.offsetHeight - mouseOverElementPaddingTop) + 'px';
