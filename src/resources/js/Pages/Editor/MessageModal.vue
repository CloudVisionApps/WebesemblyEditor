                    ...
                    <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                        <div>
                            ...
                            <div class="mt-3 text-center sm:mt-5">
                                <DialogTitle v-if="title" as="h3" class="text-lg leading-6 font-medium text-gray-900" v-html="title">
                                </DialogTitle>
                                <div class="mt-2" v-if="description">
                                    <p class="text-sm text-gray-500" v-html="description">
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    mounted() {
        let instance = this;
        document.addEventListener("JsLiveEdit::MessageModal", (event) => {
            instance.title = event.detail.title;
            instance.description = event.detail.description;
            instance.open = true;
        });
    },
    data() {
